...
func _ready():
	...
	if not GlobalVariables.has_clicked_washing_button:
...
func _on_pressed():
	...
	GlobalVariables.has_clicked_washing_button = true
	
	# Chuyển sang scene khác
	get_tree().change_scene_to_file("res://objects/tutorial_washi.tscn")
